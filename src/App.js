      ...
      <FormControl sx={{ m: 0, width: 300 }}>
        ...
        <div>
          ...
          <div className="socials">
            ...
            <div className="insta"><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="23" cy="23" r="23" fill="#00002C" />
            ...
            <div className="facebook"><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="23" cy="23" r="23" fill="#00002C" />
