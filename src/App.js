                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="wrapper">
                      ...
                      <div className="cell">
                        ...
                        <TextField type="text" onChange={handleChange} name="commitments" label="Tech Teams or Clubs you're part of" sx={{ width: 300, border: '1px solid white', color: 'white', borderRadius: '2px' }} />
                      </div>
                      <div id="submitBtn">
                        <div className="registerBtnBorder">
                          <input
